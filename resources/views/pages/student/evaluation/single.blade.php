...
@section('content')
                    ...
                    <div class="card mb-3 pb-0 w-100 mt-2">
                        ...
                        <div class="card-body">
                            ...
                            <h5>
                                Company : <span class="h6">{{$evaluation->formations->company->name}} </span> 
                            <h5/>
                            <h5>
                                ...
                                <table class="table card-table table-striped table-vcenter text-nowrap mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><span>Environment</span></th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $evaluation->environment}}</td>
                                            <td class="text-center">{{ $evaluation->content}}</td>
